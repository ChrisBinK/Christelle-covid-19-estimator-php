...
Class Impact implements JsonSerializable
{
    ...
    public function estimate($periodType,$timeToElapse, $totalHospitalBeds,$population, $avgDailyIncomeInUSD,$avgDailyIncomePopulation){
        ...
        $this->dollarsInFlight = floor( ($this->infectionsByRequestedTime * $avgDailyIncomeInUSD)/ $this->numberOfDays);//$avgDailyIncomePopulation) ;//* $avgDailyIncomeInUSD * $timeToElapse; //$this->numberOfDays; // I have conerted the days  or monh timeToElapse to days
