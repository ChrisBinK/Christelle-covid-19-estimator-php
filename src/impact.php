...
Class Impact implements JsonSerializable
{
    ...
    public function estimate($periodType,$timeToElapse, $totalHospitalBeds,$population, $avgDailyIncomeInUSD,$avgDailyIncomePopulation){
        ...
        $this->dollarsInFlight = floor( ($this->infectionsByRequestedTime * $avgDailyIncomePopulation *$avgDailyIncomeInUSD ) / $this->numberOfDays); // I have conerted the days  or monh timeToElapse to days
